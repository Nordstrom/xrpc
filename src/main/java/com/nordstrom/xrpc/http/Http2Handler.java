...
public class Http2Handler extends Http2ConnectionHandler {
  ...
  private static final AttributeKey<Integer> STREAM_ID_KEY = AttributeKey.newInstance("xrpc_h2_stream_id");
  ...
  private void writeHeaders(ChannelHandlerContext ctx, Http2Headers headers, boolean eos, ChannelPromise promise) throws Exception {
    encoder().writeHeaders(ctx, currentStreamId, headers, 0, Http2CodecUtil.DEFAULT_PRIORITY_WEIGHT, false, 0, eos, promise);
  }

  private void writeData(ChannelHandlerContext ctx, Http2DataFrame data, ChannelPromise promise) throws Exception {
  ...
  public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
    ...
    if (!(msg instanceof Http2DataFrame || msg instanceof Http2Headers || msg instanceof Http2Response)) {
