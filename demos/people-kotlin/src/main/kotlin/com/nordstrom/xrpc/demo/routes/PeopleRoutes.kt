...
import com.nordstrom.xrpc.demo.extensions.Routable
import com.nordstrom.xrpc.demo.extensions.RouteSpec
import com.nordstrom.xrpc.demo.model.Person
import com.nordstrom.xrpc.demo.util.MoshiAdapterFactory
...
class PeopleRoutes : Routable {
    ...
    private fun postPerson(request: XrpcRequest): HttpResponse {
        return MoshiAdapterFactory.personAdapter.fromJson(request.dataAsString)?.let {
            people.add(it)
            request.okResponse()
